...
const AdminDashboardTrial = () => {
  ...
  const renderContent = () => {
    switch (activeSection) {
      case "home":
        return <div>Welcome to the Admin Dashboard Home Page!</div>;
      case "students":
        return <div>Manage Students</div>;
      case "teachers":
        return <div>Manage Teachers</div>;
      case "courses":
        return <div>Manage Courses</div>;
      case "consult":
        return <div>View Consult Inquiries</div>;
      case "fees":
        return <div>Manage Fees</div>;
      case "notifications":
        return <div>Send Push Notifications</div>;
      case "schedule":
        return <div>Manage Schedules</div>;
      case "feedback":
        return <div>View Feedbacks</div>;
      default:
          ...
          <div>
            ...
            {isProfileOpen && (
              <div className="absolute right-0 mt-2 w-48 bg-white shadow-md rounded-md border border-gray-300 z-50">
                <div className="p-2">
                  <h3 className="font-semibold">Samarth Doshi</h3>
                  <p className="text-sm text-gray-500">admin2@example.com</p>
                </div>
...
export default AdminDashboardTrial;
