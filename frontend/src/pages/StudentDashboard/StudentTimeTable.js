...
const StudentTimeTable = () => {
  ...
  useEffect(() => {
    const fetchTimeTable = async () => {
      try {
        ...
        const res = await axios.get(`${process.env.REACT_APP_BACKEND_URL}/api/timetable/getTimeTable`, {
  ...
  return (
    <div className="container mx-auto p-6">
      <h1 className="text-2xl font-bold mb-4 text-center">My TimeTable</h1>
