...
const TeacherSidebar = ({ setActiveSection, isSidebarOpen, setIsSidebarOpen }) => {
  return (
<div 
    ...
    <button 
      ...
      <nav className="p-4 overflow-y-scroll scrollbar-custom"> 
      ...
      <div className="p-4 border-t border-gray-700">
        <button className="w-full bg-green text-white py-2 px-4 rounded-lg hover:bg-blue-500"
            onClick={() => setActiveSection("notifications")} // 👈 Activate notifications section
>
          Send Announcements
        </button>
      </div>
